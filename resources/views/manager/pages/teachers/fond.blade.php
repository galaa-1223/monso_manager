...
@section('subcontent')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="{{ route('manager-teachers-add') }}" class="btn bg-theme-1 text-white shadow-md mr-2">Багш нэмэх</a> 
            <div class="pos-dropdown dropdown ml-auto sm:ml-0">
                ...
                <div class="pos-dropdown__dropdown-menu dropdown-menu">
                    <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                        <a href="{{ route('manager-tenhim-add') }}" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="activity" class="w-4 h-4 mr-2"></i> <span class="truncate">Тэнхим нэмэх</span> </a>
                    </div>
                </div>
            </div>
        </div>
