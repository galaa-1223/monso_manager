...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <a href="{{ route('manager-huvaari-angi') }}" class="intro-y col-span-12 lg:col-span-4 box py-10 border-2 border-theme-1 dark:border-theme-1">
        ...
        <div class="intro-y col-span-12 box p-5">
            ...
            <div class="overflow-x-auto scrollbar-hidden">
                <div class="mt-5 table-report table-report--tabulator" id="angi_huvaari_tabulator"></div>
            </div>
            @endif
        </div>
        <!-- END: HTML Table Data -->
