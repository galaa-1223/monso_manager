...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form class="validate-form-teacher validate-form" action="{{ route('manager-mergejil_bagsh-edit', $mergejilBagsh->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <!-- BEGIN: Тэнхим нэмэх -->
                <div class="intro-y box p-5">
                    ...
                    <div class="flex justify-end mt-4">
                        <a href="{{ route('manager-mergejil_bagsh') }}" type="submit" class="btn w-40 bg-theme-1 text-white ml-5">Болих</a>
