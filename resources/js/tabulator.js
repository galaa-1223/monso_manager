                ...
                },
                {
                    ...
                    formatter(cell, formatterParams) {
                        return `<div class="flex items-center lg:justify-center text-theme-9">
                                    <a class="flex items-center mr-3" href="/manager/huvaari/bagsh/${cell.getData().id}">
        ...
        let table = new Tabulator("#teacher_fond_tabulator", {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter(cell, formatterParams) {
                        return `<div class="flex items-center lg:justify-center text-theme-9">
                                    <a class="flex items-center mr-3" href="/manager/teachers/fond_list/${cell.getData().id}">
