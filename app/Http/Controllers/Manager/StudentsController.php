...
class StudentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('manager-students')->with('success', 'Оюутан амжилттай нэмэгдлээ!'); 
                break;
    ...
    public function update(Request $request, $id)
    {
        ...
        switch ($request->input('action')) {
            case 'save':
                return redirect()->route('manager-students')->with('success', 'Оюутан засварлагдлаа!'); 
                break;
            case 'preview':
                echo 'preview';
                break;
